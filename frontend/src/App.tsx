...
export default function App() {
  ...
  return (
    <div className="h-screen flex flex-col bg-background">
      {/* Header - 2 rows */}
      <header className="shrink-0 bg-card/95 backdrop-blur-md border-b border-border">
        {/* Row 1: Logo + Actions */}
        <div className="h-11 flex items-center justify-between px-6">
          {/* Left - Logo Area (placeholder for future image) */}
      ...
      {/* Footer */}
      <footer className="shrink-0 h-14 bg-card/50 border-t border-border px-6 flex items-center justify-between">
